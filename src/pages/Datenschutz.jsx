...
export default function Datenschutz() {
    return (
        <div className="legal-page">
            <Helmet>
                <title>Datenschutz | Best Social Media Management – famefact</title>
                <meta name="description" content="Datenschutzerklärung von best-social-media-management.com – Ein Service von famefact / track by track GmbH." />
