...
export default function AGB() {
    return (
        <div className="legal-page">
            <Helmet>
                <title>AGB | Best Social Media Management – famefact</title>
                <meta name="description" content="Allgemeine Geschäftsbedingungen von best-social-media-management.com – Ein Service von famefact / track by track GmbH." />
            ...
            <div className="container">
                ...
                <p>
                    ...
                    Beratungs- und Dienstleistungen im Bereich Social Media Management, Community Management und digitales Marketing.
                </p>

                <h2>§ 2 Vertragsgegenstand</h2>
                <p>
                    Die Agentur erbringt Dienstleistungen im Bereich Social Media Management, Community Management,
                    Content Creation und digitales Marketing. Der genaue Umfang der Leistungen ergibt sich aus dem
                ...
                <p>
                    Der Kunde erhält an den im Rahmen des Social Media Managements erstellten Inhalten einfache Nutzungsrechte
                    für die vereinbarte Dauer und Plattform. Die Agentur behält sich das Recht vor, die erstellten Arbeiten
                    zu Eigenwerbezwecken zu verwenden.
                </p>
